...
function HowToPlay() {
    ...
    return (
        <div className={classes.container}>
            ...
            <ArrowBackIcon className={page > 1 ? classes.arrowButton : classes.disabled} onClick={page > 1 ? previousPage : null} />
            <ArrowForwardIcon className={page < 12 ? classes.arrowButton : classes.disabled} onClick={page < 12 ? nextPage : null} />
            <hr className={classes.hr} />
            <Pagination
                count={12}
                page={page}
